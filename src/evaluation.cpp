...
inline Evaluation midlegame_evaluate(Position const& b) {
	return
		(bb_popcount(b.get_discs(WHITE) & 0xffff'0000'0018'1818) - bb_popcount(b.get_discs(BLACK) & 0x1818'1800'0000'ffff)) * 102 +
		(bb_popcount(b.get_discs(WHITE) & 0x0000'ffff'0000'0000) - bb_popcount(b.get_discs(BLACK) & 0x0000'0000'ffff'0000)) * 101 +
		(bb_popcount(b.get_discs(WHITE) & 0x0000'0000'ffe7'6666) - bb_popcount(b.get_discs(BLACK) & 0x6666'e7ff'0000'0000)) * 100 +
